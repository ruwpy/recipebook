...
export default function FormIngridients({ingridients, setIngridients}) {
      ...
      <div className="recipeform__items">
        {
          ingridients.map((ingridient) => {
            return (
              <div className='recipeform__single-item' key={ingridient.id}>
                <input
                ...
                <input
                  ...
                  id={ingridient.id}
                />
                <span onClick={() => deleteIngridient(ingridient.id)} className="recipeform__delete-item">
                  <img 
        ...
        <span onClick={() => addNewIngridient()} className='recipeform__add'>добавить ингредиент +</span>
    </>
  )
}
